            ...
            item.update(
                {
                    ...
                    "nutrition": {
                        ...
                        "calories": float(aliment_data.calories)
                        if aliment_data.calories is not None
                        else 0.0,
                        "proteines": float(aliment_data.proteines)
                        if aliment_data.proteines is not None
                        else 0.0,
                        "glucides": float(aliment_data.glucides)
                        if aliment_data.glucides is not None
                        else 0.0,
                        "lipides": float(aliment_data.lipides)
                        if aliment_data.lipides is not None
                        else 0.0,
                    },
                }
            )
